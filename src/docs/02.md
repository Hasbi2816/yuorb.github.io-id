...
<details>
    ...
    <div class="indent">
        <dl>
            ...
            <dd>（为）标签/绰号【加上贴上标签的实体】；标签/绰号为某某</dd>
        </dl>
        <dl>
...
<details>
    ...
    <div class="indent">
        <dl>
            ...
            <dd>（为）一次创作一段音乐、一个乐句、一个旋律、一个曲子的状态/行为；创作一个旋律/曲子/乐句或乐段</dd>
        </dl>
        <dl>
...
2. 单词从重读音节开始，发话者可以自由选择以下任何一种音高轮廓：降调、高平调、升降调和降升调。在以下情况下，还可以使用其他音高轮廓：
   ...
   * 对于具有非**叙事域**的子句，可以选择在言域子句的第一个及最后一个词上使用低平调（这种情况下不需要使用域尾小词）。
